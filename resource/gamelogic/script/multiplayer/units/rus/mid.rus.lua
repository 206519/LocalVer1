	...
	{Repeat = 0,  --infinite
		Units = {
			...
			-- Infantry Squads
				...
				{priority = 1.0, type = {"Infantry", "Squad", "AT", "Class2",}, unit = "squad_at_rifle(rus)"},
				...
				-- Offensive Doctrine Squads
					...
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_guards_para_mid_off_2(rus)"},
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_guards_para_mid_off_3(rus)"},
					--]]
			...
			-- Cannons
				...
				{priority = 1.0, type = {"Cannon", "MG", "AA", "Class2",}, unit = "dshk_aa"},
				{priority = 1.0, type = {"Cannon", "AA", "Class2",}, unit = "37mm_61k"},
				{priority = 1.0, type = {"Cannon", "AA", "Class3",}, unit = "85mm_52k"},
				...
				--{priority = 1.0, type = {"Cannon", "Support", "Class2",}, unit = "m41_ampulomet"},

				{priority = 1.0, type = {"Cannon", "Support", "Class1",}, unit = "76mm_m1927"},

				{priority = 1.0, type = {"Cannon", "Support", "Class2",}, unit = "76mm_m1902"},

				{priority = 1.0, type = {"Cannon", "Mortar", "Class1",}, unit = "82mm_bm37"},

				{priority = 1.0, type = {"Cannon", "Mortar", "Class3",}, unit = "120mm_pm38"},

				{priority = 1.0, type = {"Cannon", "Artillery", "Class1",}, unit = "122mm_m30"},

				{priority = 1.0, type = {"Cannon", "Artillery", "Class2",}, unit = "122mm_a19"},
				{priority = 1.0, type = {"Cannon", "Artillery", "Class2",}, unit = "152mm_ml20"},
			...
			-- Wheeled vehicles
				...
				{priority = 1.0, type = {"Vehicle", "Artillery", "Class3",}, unit = "bm13_studebaker"},
			...
			-- Tanks
				...
				{priority = 1.0, type = {"Tank", "Light", "Class1",}, unit = "t60"},
				{priority = 1.0, type = {"Tank", "Light", "Class3",}, unit = "t70"},
				--{priority = 1.0, type = {"Tank", "Light", "Class3",}, unit = "bt7a"},
				--{priority = 1.0, type = {"Tank", "Light", "Class2",}, unit = "su26"},
				...
				{priority = 1.0, type = {"Tank", "Medium", "Class2",}, unit = "t3476_41e"},
				{priority = 1.0, type = {"Tank", "Medium", "Class2",}, unit = "t3476_43_flame"},
				{priority = 1.0, type = {"Tank", "Medium", "Class2",}, unit = "t3457_41"},

				{priority = 1.0, type = {"Tank", "Heavy", "Class2",}, unit = "t35_late"},
				{priority = 1.0, type = {"Tank", "Heavy", "Class2",}, unit = "kv8"},
				{priority = 1.0, type = {"Tank", "Heavy", "Class1",}, unit = "kv1_41"},
				{priority = 1.0, type = {"Tank", "Heavy", "Class3",}, unit = "kv1s"},
				{priority = 1.0, type = {"Tank", "Heavy", "Class3",}, unit = "kv1_42"},
				{priority = 1.0, type = {"Tank", "Heavy", "Class3",}, unit = "kv2_40"},
				{priority = 1.0, type = {"Tank", "Heavy", "Class3",}, unit = "su100y"},
				--]]
			...
			-- Self-Propelled Guns
				...
				{priority = 1.0, type = {"Tank", "Light", "AT", "Class2",}, unit = "zis30"},
				{priority = 1.0, type = {"Tank", "Light", "Medium", "Class3",}, unit = "su122"},
				--]]
			...
			--{priority = 1.0, type = {"Class", "Doctrine", "Tier1", "Tank", "Heavy",}, unit = "doctrine_t35_mid"},
