		...
		Units = {
			...
			-- Infantry Squads
				...
				-- Irregular Doctrine Squads
					...
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_para_recon_early_irr(rus)"},
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_para_early_irr(rus)"},
					--]]
			...
			-- Cannons
				...
				{priority = 1.0, type = {"Cannon", "AA", "Class1",}, unit = "dshk_aa"},
				...
				{priority = 1.0, type = {"Cannon", "AT", "Class2",}, unit = "76mm_bpk76"},
				...
				{priority = 1.0, type = {"Cannon", "Artillery", "Class1",}, unit = "107mm_m1910_30"},
				{priority = 1.0, type = {"Cannon", "Artillery", "Class2",}, unit = "120mm_pm38"},
			...
			-- Tanks
				...
				{priority = 3.0, type = {"Tank", "Light", "Class1",}, unit = "bt7"},

				{priority = 1.0, type = {"Tank", "Light", "Class1",}, unit = "t26_38"},
				{priority = 3.0, type = {"Tank", "Light", "Class1",}, unit = "t26_39"},
				...
				--{priority = 1.0, type = {"Tank", "Heavy", "Class1",}, unit = "t35"},
				--{priority = 1.0, type = {"Tank", "Heavy", "Class2",}, unit = "t35_late"},
				--{priority = 1.0, type = {"Tank", "Heavy", "Class2",}, unit = "smk"},
				{priority = 1.0, type = {"Tank", "Heavy", "Class2",}, unit = "kv1_39"},
