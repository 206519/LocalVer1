		...
		Units = {
			...
			-- Infantry Squads
				...
				-- Irregular Doctrine Squads
					...
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_fallschirm_pio_mid_irr(ger)"},
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_fallschirm_mid_irr(ger)"},
					--]]
				...
				-- Offensive Doctrine Squads
					...
					{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_gd_pio_mid_off(ger)"},
			...
			-- Cannons
				...
				--{priority = 1.0, type = {"Class3", "Cannon", "MG",}, unit = "mg34_lafette"},
				{priority = 1.0, type = {"Class2", "Cannon", "AA",}, unit = "20mm_flak38"},

				--{priority = 1.0, type = {"Class2", "Cannon", "AA",}, unit = "37mm_flak37"},
				--{priority = 1.0, type = {"Class2", "Cannon", "AA",}, unit = "50mm_flak41"},
				{priority = 1.0, type = {"Class2", "Cannon", "AA",}, unit = "88mm_flak18"},

				--{priority = 1.0, type = {"Class3", "Cannon", "AT",}, unit = "28mm_pzb41"},
				--{priority = 1.0, type = {"Class3", "Cannon", "AT",}, unit = "37mm_pak36"},
				{priority = 1.0, type = {"Class1", "Cannon", "AT",}, unit = "50mm_pak38"},
				{priority = 1.5, type = {"Class1", "Cannon", "AT",}, unit = "75mm_pak40"},

				{priority = 0.5, type = {"Class2", "Cannon", "AT",}, unit = "75mm_pak9738"},
				{priority = 1.0, type = {"Class2", "Cannon", "AT",}, unit = "88mm_pak4341"},

				{priority = 1.0, type = {"Class2", "Cannon", "Support",}, unit = "75mm_leig18"},

				--{priority = 1.0, type = {"Class3", "Cannon", "Support",}, unit = "75mm_legebig18"},
				...
				{priority = 1.0, type = {"Class3", "Cannon", "Artillery",}, unit = "150mm_sig33_late"},
				--{priority = 1.0, type = {"Class1", "Cannon", "Artillery",}, unit = "150mm_sfh18"},
				--{priority = 1.0, type = {"Class1", "Cannon", "Artillery",}, unit = "170mm_k18"},
				--]]
			...
			-- Wheeled vehicles
				...
				--{priority = 1.0, type = {"Class3", "Vehicle", "AA",}, unit = "blitz3_6_flak30"},

				--{priority = 1.0, type = {"Class2", "Armored", "MG",}, unit = "sdkfz221"},
				{priority = 1.0, type = {"Class2", "Armored", "AA",}, unit = "sdkfz222a"},
				--{priority = 1.0, type = {"Class2", "Armored", "AA",}, unit = "sdkfz231"},
			...
			-- Half Tracks
				...
				{priority = 1.0, type = {"Class3", "Armored", "AA",}, unit = "sdkfz7_2"},
				--{priority = 1.0, type = {"Class3", "Armored", "AT",}, unit = "sdkfz10_pak38"},
				--{priority = 1.0, type = {"Class3", "Armored", "AT",}, unit = "sdkfz8_flak18"},
				--]]

			-- Tanks
				---[[
				--{priority = 1.0, type = {"Tank", "Light", "Class1",}, unit = "panzer2f"},
				--{priority = 1.0, type = {"Tank", "Light", "Class1",}, unit = "pz38t_f"},

				{priority = 1.0, type = {"Class2", "Tank", "Light",}, unit = "pz38t_g"},

				{priority = 1.0, type = {"Class2", "Tank", "Medium",}, unit = "panzer3j"},
				{priority = 1.0, type = {"Class1", "Tank", "Medium",}, unit = "panzer3j1"},
				{priority = 1.0, type = {"Class1", "Tank", "Medium",}, unit = "panzer4f1"},
				{priority = 1.0, type = {"Class3", "Tank", "Medium",}, unit = "panzer4f2"},

				{priority = 2.0, type = {"Class1", "Tank", "Medium",}, unit = "panzer3l"},
				{priority = 2.0, type = {"Class1", "Tank", "Medium",}, unit = "panzer3m"},
				--{priority = 1.5, type = {"Class3", "Tank", "Medium",}, unit = "panzer3n"},
				--{priority = 1.0, type = {"Class3", "Tank", "Medium",}, unit = "panzer3_flamm"},
				{priority = 2.0, type = {"Class1", "Tank", "Medium",}, unit = "panzer4g"},
				{priority = 2.0, type = {"Class1", "Tank", "Medium",}, unit = "panzer4h"},

				{priority = 1.0, type = {"Class1", "Tank", "Medium",}, unit = "panzer5a"},
				{priority = 1.0, type = {"Class2", "Tank", "Medium",}, unit = "panzer5d"},

				{priority = 1.0, type = {"Class1", "Tank", "Heavy",}, unit = "tiger1h"},
				{priority = 1.0, type = {"Class2", "Tank", "Heavy",}, unit = "tiger1e"},
				--{priority = 1.0, type = {"Class3", "Tank", "Heavy",}, unit = "pz756r"},
				--]]

			-- Self-Propelled Guns
				---[[
				--{priority = 1.0, type = {"Class3", "Tank", "Light", "AT",}, unit = "panzerjager1"},
				--{priority = 1.0, type = {"Class3", "Tank", "Medium", "AT",}, unit = "stug3b"},

				--{priority = 1.0, type = {"Class3", "Tank", "Light", "AT",}, unit = "marder2"},
				--{priority = 1.0, type = {"Class3", "Tank", "Medium", "AT",}, unit = "stug3f"},
				{priority = 1.0, type = {"Class3", "Tank", "Medium", "AT",}, unit = "stug3g"},
				{priority = 1.0, type = {"Class3", "Tank", "Medium", "AT",}, unit = "stuh42"},
				--{priority = 1.0, type = {"Class3", "Tank", "Light", "Support",}, unit = "bison"},
				--{priority = 1.0, type = {"Class3", "Tank", "Medium", "Support",}, unit = "sig33b"},
				--{priority = 1.0, type = {"Class3", "Tank", "Medium", "Support",}, unit = "sturmpanzer4"},
				--]]
